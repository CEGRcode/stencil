...
const siteConfig = {
  title: "Stencil", // Title for your website.
  tagline:
    "A web templating engine for visualizing and sharing life science datasets",
  url: "https://pughlab.mbg.cornell.edu", // Your website URL
  baseUrl: "/stencil/", // Base URL for your project */
  ...
  */
  ...
  stylesheets: [
    ...
    "/stencil/css/code-block-button.css",
  ],
  ...
  scripts: [
    ...
    "/stencil/js/code-block-button.js",
  ],
  ...
  // scroll to top button at the bottom of the page.
  scrollToTop: true,
  ...
  repoUrl: "https://github.com/CEGRcode/stencil/",
};
