...
function SwarmPlot_stencil(props) {
  ...
  const plotOptions = {
    ...
    ...(props.chartOptions['valueScale']?{
      valueScale: {
        ...(props.chartOptions['valueScale']['type']?{ type: props.chartOptions['valueScale']['type']}:{ type: "linear" }),
        ...(props.chartOptions['valueScale']['min']?{ min: props.chartOptions['valueScale']['min']}:{ min: 0 }),
        ...(props.chartOptions['valueScale']['max']?{ max: props.chartOptions['valueScale']['max']}:{ max: 1000 }),
        ...(props.chartOptions['valueScale']['reverse']?{ reverse: props.chartOptions['valueScale']['reverse']}:{ reverse: false })
      },}:{ }),

    ...(props.chartOptions['size']?{
      size: {
        ...(props.chartOptions['size']['key']?{ key: props.chartOptions['size']['key']}:{ }),
        ...(props.chartOptions['size']['values']?{ values: props.chartOptions['size']['values']}:{ }),
        ...(props.chartOptions['size']['sizes']?{ sizes: props.chartOptions['size']['sizes']}:{ })
      },}:{ }),
  ...
  const handleExport = () => {
    ...
    downloadLink.download = "Swarmplot.svg";
...
SwarmPlot_stencil.propTypes = {
  classes: PropTypes.object
};

export default SwarmPlot_stencil;
